...
<?php elseif( $parent_slug == "rd" ): ?>
            <img class="floating-object bottom-left" src="<?php bloginfo('template_url'); ?>/imgs/common/bg_obj03.png" />
            <img class="floating-object top-right" src="<?php bloginfo('template_url'); ?>/imgs/common/bg_obj04.png" />
<?php endif; ?>
            <div class="bg-book">
                <div class="contents">
